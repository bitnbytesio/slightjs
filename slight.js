...
Slight = new SlightPlugin({url:"http://localhost/"});
Slight.router('/test/test.html', function(){}).scripts(['/test/script.js']).css(['test/style.css']);
Slight.router('/test/tes.html', function(){}).after(function(){ alert('i reached 2 /test/drag-out') });
Slight.router('/test/pros.php', function(){});
Slight.router('/test/drop-out', function(){}).after(function(){ alert('i reached 4 /test/drop-out') });
Slight.router('/test/user/:uid', function(){}).before(function(){ alert('i reached uid') });
Slight.router('/test/user/:uid/pictures/?pid', function(){}).before(function(){ alert('i reached pid pictures') });
Slight.listen();
...
/*
  headers: {
        ...
        'X_REQUEST_TOKEN': 'xxxxxxxxxxxxxxxx',
    }
    */
